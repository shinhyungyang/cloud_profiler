...
public class AdvertisingTopology {
    ...
    private static final Logger LOG = Logger.getLogger(AdvertisingTopology.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        opts.addOption("measurementgraph", true, "Measurement actors information in csv format with \";\" character as a newline");

        CommandLineParser parser = new DefaultParser();
        CommandLine cmd = parser.parse(opts, args);
        String configPath = cmd.getOptionValue("conf");
        Map commonConfig = Utils.findAndReadConfigFile(configPath, true);
        String measurementGraph = cmd.getOptionValue("measurementgraph");
        LOG.info("Measurement Graph: " + measurementGraph);
